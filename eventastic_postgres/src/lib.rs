...
impl PartialEventRow {
    fn to_event<Evt>(
        row: PartialEventRow,
    ) -> Result<eventastic::event::EventStoreEvent<Uuid, Evt>, sqlx::Error>
    where
